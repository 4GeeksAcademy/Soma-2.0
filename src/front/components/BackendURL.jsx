...
export const BackendURL = () => (
	<div className="mt-5 pt-5 w-50 mx-auto">
		...
		<p>
			There&apos;s one variable called <Dark>BACKEND_URL</Dark> that needs to be manually set by yourself.
		</p>
		<ol>
			...
			<li>
				Replace <Dark>your api host</Dark> with the public API URL of your flask backend sever running at port 3001
			</li>
		</ol>
		<div className="w-100">
		...
		<p>
			Note: If you are publishing your website to Heroku, Render.com or any other hosting you probably need to follow
			other steps.
		</p>
	</div>
);
