...
export const DashboardAdmin = () => {
    ...
    return (
        <div className="min-h-screen bg-paper px-4 py-8 md:px-8 lg:px-12 font-body text-ink">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 bg-paper-alt p-1.5 rounded-sm border border-nude/40 shadow-card">
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold rounded-xs transition-all ${rango === "hoy" ? "bg-cafe text-white shadow-soft" : "text-ink-soft hover:text-ink hover:bg-paper"
                                }`}
                        >
                            Hoy
                        </button>
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold rounded-xs transition-all ${rango === "semana" ? "bg-cafe text-white shadow-soft" : "text-ink-soft hover:text-ink hover:bg-paper"
                                }`}
                        >
                            Esta Semana
                        </button>
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold rounded-xs transition-all ${rango === "mes" ? "bg-cafe text-white shadow-soft" : "text-ink-soft hover:text-ink hover:bg-paper"
                                }`}
                        >
                            Este Mes
                        </button>
                        <button
                            ...
                            className={`px-3 py-1.5 text-xs font-semibold rounded-xs transition-all ${rango === "personalizado" ? "bg-cafe text-white shadow-soft" : "text-ink-soft hover:text-ink hover:bg-paper"
                                }`}
                        >
                            Fechas
                        </button>
            ...
            {error && (
                <div className="max-w-7xl mx-auto mb-6 p-4 rounded-sm bg-error-bg text-error-text border border-error-text/20 flex items-center
  justify-between">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 pb-3 border-b border-paper-alt">
                            ...
                            <div className="flex items-center bg-paper-alt p-1 rounded-xs">
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs font-semibold rounded-xs transition-all ${tabCitas === "hoy" ? "bg-white text-ink shadow-card" : "text-ink-soft"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs font-semibold rounded-xs transition-all ${tabCitas === "semana" ? "bg-white text-ink shadow-card" : "text-ink-soft"
                                        }`}
                                >
                        ...
                        {cargando ? (
                            ...
                            return (
                                <div className="space-y-3 max-h-[350px] overflow-y-auto pr-1">
                                    {citas.map((c) => (
                                        <div key={c.id} className="p-3 rounded-xs bg-paper/50 border border-nude/30 flex items-center justify-between
  text-sm">
                                            <div>
                                            ...
                                            <div className="text-right">
                                                <div className="font-data font-semibold text-ink text-xs">
                                                    {formatTime(c.fecha_hora)}
                                                </div>
                                                <div className="text-[11px] text-ink-faint">
                                                    {formatDateShort(c.fecha_hora)}
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                ...
                <div className="fixed inset-0 bg-ink/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-md shadow-glass max-w-sm w-full p-6">
                        ...
                        <div className="mt-6 flex justify-end gap-2">
                            <button onClick={() => setMostrarModalFiltro(false)} className="px-3 py-1.5 text-xs font-semibold text-ink-soft">
                                Cancelar
                            </button>
                            <button
                                onClick={() => {
